<%-- 
    Document   : index
    Created on : 14 Jul, 2020, 1:28:47 PM
    Author     : dprisky
--%>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <form class="user" method="post" action="check.jsp">                    
                    <div class="form-group">
                     <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email" value="<%=s%>" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
