<%-- 
    Document   : album
    Created on : 18 Jul, 2020, 8:40:35 PM
    Author     : dprisky
--%>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 <form method="post" action="add_album.jsp">
                        <label>Album/Movie :</label>
                        <input type="text" name="album" placeholder="Category Name" class="form-control" required><br>
                        <label>Album/Movie Description :</label>
                        <textarea name="desc" placeholder="Album/Movie Description" class="form-control" required></textarea><br>
