<%-- 
    Document   : upload_songs
    Created on : 27 Jul, 2020, 11:10:01 AM
    Author     : dprisky
--%>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-12">
              <div class="card shadow mb-12">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <form method="post" action="upload_song.jsp?album=<%=album_code%>&ccode=<%=ccode%>&id=<%=sn%>" ENCTYPE='multipart/form-data'>
				 <label>Song :</label>
