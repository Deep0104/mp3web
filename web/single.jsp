<%-- 
    Document   : single.jsp
    Created on : 25 Dec, 2020, 1:23:13 PM
    Author     : dprisky
--%>
...
<!DOCTYPE HTML>
<%@page contentType="text/html" import="java.sql.*,javax.servlet.http.*,javax.servlet.http.Cookie,java.util.*" pageEncoding="UTF-8"%>
				...
				<div class="inner-content single">
						...
						<div class="tittle-head">
						   ...
						   <div class="single_left">
                                                       <script>
                                                           $(document).ready(function(){
                                                            $(".fa.fa-play").click(function(){
                                                                var song=$(this).attr("id")+".mp3";

                                                                var albumcode = "<%=request.getParameter("album")%>";
                                                                var target="song/"+albumcode+"/"+song;
                                                                
                                                                $("#song").attr("src",target);
                                                              //  #("#myModal").modal();
                                                            });
                                                           });
                                                    ...
                                                    <%
                                                        String ac = request.getParameter("album");
                                                        try{
        
                                                                Class.forName("com.mysql.jdbc.Driver");
                                                                Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/mp3","root","");
                                                                Statement st=cn.createStatement();
                                                                ResultSet rs=st.executeQuery("select * from song where status=0 and  album_code='"+ac+"'");
                                                                while(rs.next()){
                                                                    int k=rs.getInt("sn");
                                                                    
                                                                    String n=rs.getString("song");
                                                    %>
                                                       <div>
                                                           <h3><i  class="fa fa-play" style="font-size:36px;color:red" id="<%=k%>" ></i><%=n%></h3>
