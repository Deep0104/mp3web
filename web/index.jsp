<%-- 
    Document   : index
    Created on : 14 Jul, 2020, 1:26:37 PM
    Author     : dprisky
--%>
    ...
    <section>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list"><a href="browse.jsp"><i class="lnr lnr-indent-increase"></i> <span>Category</span></a>  
							<ul class="sub-menu-list">
                                                        ...
                                                        %>
                                                        <li><a href="browse.jsp?category=<%=rs.getString("code")%>">&nbsp;&nbsp;&nbsp;<%=k%></a></li>
                                            <%
                                                            }
                                                        cn.close();
                                                    }
								...
								<div class="tittle-head">
									...
									<div class="clearfix"> </div>
                                                                    ...
                                                                    try{
                                                                        ...
                                                                        while(rs.next()){
                                                                            String alcode=rs.getString("code");
                                                                                    %>
                                                                                    <div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="album/<%=rs.getString("code")%>.jpg" title="allbum-name"></a>
								<a  href="single.jsp?album=<%=alcode%>">Listen now</a>
							</div>
											...
											<div class="jp-type-playlist">
												...
												<div class="jp-playlist">
                                                    ...
                                                    <%
                                                        ...
                                                        %>
                                            <a  class="jp-playlist-item-remove" style="display: none;">×</a><a  class="jp-playlist-item jp-playlist-current"  tabindex="0"><%=c%><i class="fa fa-trash" style="color:red;float:right"  id="<%=rs.getString("code")%>"></i>
                                            <%
                                                            }
                                                        cn.close();
                                                    }
 	 ...
 	 <!-- /w3l-agile -->
        ...
        <!--footer section start-->
			<footer>
			   <p>&copy 2020 Risky Mp3 Player. All Rights Reserved | Design by Risky</p>
			</footer>
        <!--footer section end-->
 	 <!-- /w3l-agile -->
      <!-- main content end-->
